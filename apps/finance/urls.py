...
urlpatterns = [
    ...
    path('expence/categoriya_total/', expence_views.ExpenceCategoryTotalApiView.as_view(), name='expence_category_total_api'),
    ...
    path('income/categoriya_total/', income_views.IncomeCategoryTotalApiView.as_view(), name='income_category_total_api'),
